...
- [Open-Props](https://open-props.style/) - CSS framework


### What I learned

- Using Open-Props framework
...
- [Open-Props](https://open-props.style/) - This helped me writing less CSS code using custom properties.
